...
<section class="shopping-cart">
    ...
    <div class="more-btn">
        <a href="cart.php?delete_all" class="delete-btn <?php echo ($Total_Amount > 1)?'':'disabled' ?>" onclick="return confirm('delete all from cart?');">delete all</a>
    </div>

    <div class="cart-total">
        <p>Total Amount: <span>Rs.<?php echo $Total_Amount; ?>/-</span></p>
        <a href="shop.php" class="option-btn">continue shopping</a>
        <a href="checkout.php" class="btn  <?php echo ($Total_Amount > 1)?'':'disabled' ?>">proceed to checkout</a>
    </div>
