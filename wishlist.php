...
<section class="wishlist">
    ...
    <?php
    $Total_Amount += $fetch_wishlist['price'];
        }
    }else{
    ...
    <div class="wishlist-total">
        ...
        <a href="wishlist.php?delete_all" class="delete-btn <?php echo ($Total_Amount > 1)?'':'disabled' ?>" onclick="return confirm('delete all from wishlist?');">delete all</a>
    </div>
