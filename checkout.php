...
<section class="display-order">
    ...
    ?>
    <div class="Total Amount">Total Amount : <span>Rs.<?php echo $Total_Amount; ?>/-</span></div>
</section>
...
<section class="checkout">
    ...
    <form action="" method="POST">
        ...
        <div class="flex">
            ...
            <div class="inputBox">
                <span>city :</span>
                <input type="text" name="city" placeholder="e.g. kollupitiya">
            </div>
            <div class="inputBox">
                <span>state :</span>
                <input type="text" name="state" placeholder="e.g. colombo">
            </div>
            <div class="inputBox">
                <span>country :</span>
                <input type="text" name="country" placeholder="e.g. sri lanka">
            </div>
            <div class="inputBox">
                <span>zip code :</span>
                <input type="number" min="0" name="zip_code" placeholder="e.g. 01300">
            </div>
        </div>
